...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime3.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React5.cloneElement(element, {
...
var _excluded3 = ["parentProps", "day", "focusableDay", "selectedDays", "isDateDisabled", "currentMonthNumber", "isViewFocused"];
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React6.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const outsideCurrentMonth = React6.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const isFirstVisibleCell = React6.useMemo(() => {
  ...
  const isLastVisibleCell = React6.useMemo(() => {
...
function DayCalendar(inProps) {
  ...
  const [internalFocusedDay, setInternalFocusedDay] = React6.useState(() => focusedDay || now);
  ...
  const validSelectedDays = React6.useMemo(() => selectedDays.filter((day) => !!day).map((day) => utils.startOfDay(day)), [utils, selectedDays]);
  const transitionKey = `${currentYearNumber}-${currentMonthNumber}`;
  const slideNodeRef = React6.useMemo(() => React6.createRef(), [transitionKey]);
  const startOfCurrentWeek = utils.startOfWeek(now);
  const focusableDay = React6.useMemo(() => {
  ...
  const weeksToDisplay = React6.useMemo(() => {
...
var PickersMonth = React7.memo(function PickersMonth2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersMonth"
  });
  ...
  return (0, import_jsx_runtime5.jsx)(PickersMonthRoot, _extends({
    ...
    children: (0, import_jsx_runtime5.jsx)(MonthButton, _extends({}, monthButtonProps))
  }));
});
...
var MonthCalendar = React8.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(MonthCalendarRoot, _extends({
    ...
    children: getMonthsInYear(utils, value ?? referenceDate).map((month) => {
      ...
      return (0, import_jsx_runtime6.jsx)(PickersMonth, {
        selected: isSelected,
        value: monthNumber,
...
var PickersYear = React9.memo(function PickersYear2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersYear"
  });
  ...
  return (0, import_jsx_runtime7.jsx)(PickersYearRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState: props
  }, other, {
    children: (0, import_jsx_runtime7.jsx)(YearButton, _extends({}, yearButtonProps))
  }));
});
...
var YearCalendar = React10.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: utils.getYearRange([minDate, maxDate]).map((year) => {
      ...
      return (0, import_jsx_runtime8.jsx)(PickersYear, {
        selected: isSelected,
        value: yearNumber,
...
var PickersCalendarHeader = React11.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickersTranslations();
  const utils = useUtils();
  const props = useThemeProps({
    props: inProps,
...
//# sourceMappingURL=chunk-SBWHRFGW.js.map
