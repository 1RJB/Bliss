...
if (true) {
  true ? ThemeProvider3.propTypes = exactProp2(ThemeProvider3.propTypes) : void 0;
}
...
function useCurrentColorScheme(options) {
  ...
  const [, setHasMounted] = React30.useState(false);
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React31.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime10.jsx)(React31.Fragment, {
...
function createGrid(options = {}) {
  ...
  const useUtilityClasses2 = (ownerState, theme) => {
    ...
    return composeClasses2(slots, (slot) => generateUtilityClass(componentName, slot), {});
  };
...
The color object needs to have a \`main\` property or a \`${mainShade}\` property.` : formatMuiErrorMessage2(11, name ? ` (${name})` : "", mainShade));
    }
...
} });` : formatMuiErrorMessage2(12, name ? ` (${name})` : "", JSON.stringify(color2.main)));
    }
...
Please use another name.` : formatMuiErrorMessage2(20));
  }
...
function createThemeWithVars(options = {}, ...args) {
  ...
  if (!defaultScheme) {
    throw new Error(true ? `MUI: The \`colorSchemes.${defaultColorScheme}\` option is either missing or invalid.` : formatMuiErrorMessage2(21, defaultColorScheme));
  }
...
export {
  ...
  lightBlue_default,
  green_default,
  ClassNameGenerator_default3 as ClassNameGenerator_default,
...
@mui/system/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OE7DJJSO.js.map
